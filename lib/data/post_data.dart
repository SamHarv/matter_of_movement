...
List<Post> postData = [
  ...
  Post(
    ...
    body: 'Challenges can often seem insurmountable - as if they cannot be '
        'overcome.\n\n'
        'In hindsight, such obstacles are often recognised as opportunities for '
        'growth and learning.\n\n'
        'If you have a challenge that is overwhelming you, try to reframe it '
        'as an opportunity.\n\n'
        'Whether you fail or succeed, you will learn.\n\n'
  ...
  Post(
    ...
    body: 'We regularly trade our time and expertise for money.\n\n'
        ...
        'Some get so caught up trading as much time as they can for money, they forget to use the money to buy back time.\n\n'
  ...
  Post(
    ...
    body: 'We are programmed to strive for something better.\n\n'
        ...
        'This was helpful when our survival depended on it, but can now be harmful.\n\n'
        'The grass is not greener on the other side.\n\n'
        'It is greener where you water it.\n\n'
        'Work to build something of value rather than always chasing what you think will be better.',
  ),
  Post(
    title: 'Live',
  ...
  Post(
    ...
    body: 'We have been conditioned to expect to receive things when and where '
        ...
        'A product delivered to our door the next day.\n\n'
        ...
        'There are things in life which cannot and should not be delivered on '
        'demand.\n\n'
        'Patience is a virtue.\n\n'
        'Life will force us to be patient, and if we cannot accept this, we will '
        'fail in our aspirations.',
  ),
  Post(
    title: 'Do',
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '142',
    body: 'Prior to having children, I seldom gave thought to my personal '
  ...
  Post(
    ...
    body: 'Our core beliefs are often formed in childhood when we are most '
        ...
        'The best way to do so is to become aware of alternative beliefs.\n\n'
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '134',
    body: 'Learning something new and complex can be overwhelming.\n\n'
        'We may experience fear and despair if we feel the knowledge we are '
        'trying to acquire is insurmountable.\n\n'
        'We may feel we are incapable of obtaining this knowledge.\n\n'
  ...
  Post(
    title: 'Try',
    datePosted: DateTime(2024, 7, 5),
    image: 'images/1.png',
    id: '133',
    body: 'I grew up in a time and place where it was not considered "cool" '
        'to try.\n\n'
        'People were praised for being a "natural".\n\n'
        'If you were to put in effort to improve, you would be called a "try-hard".\n\n'
        'This toxic mindset meant that people\'s skills were more or less fixed, '
        'as they would not put in effort to improve.\n\n'
        'I learned as I matured that being a "try-hard" gives you a distinct '
        'advantage in life.\n\n'
        'If you are willing to try, your rate of improvement '
        'will vastly exceed those who are "too cool" (too afraid) to try.\n\n'
        'This mindset of not trying was persisted out of fear of failure.\n\n'
        'People wanted to project the image that they were infallible and effortlessly '
        'talented when in reality, they were frightened to be seen making a mistake.\n\n'
        'We must make mistakes.\n\n'
        'We must try and fail.\n\n'
        'We must grow.\n\n'
        'Be a try-hard.',
  ),
  Post(
    title: 'Pundits and Fallibility',
    ...
    body: '"Do not mistake a confident explanation for an accurate prediction" '
        ...
        'We tend to put faith in those who act confidently when they, '
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '129',
    body: 'With technological progress has come pressure to do more in less '
        'time.\n\n'
        'Whilst technology has made our lives easier, it has also '
        ...
        'The problem is the human brain is incapable of multitasking.\n\n'
  ...
  Post(
    ...
    id: '128',
    body:
        'The Batman Effect was coined by psychologist, Rachel White in 2016.\n\n'
        'It refers to the concept of taking on the persona of a character who is '
        'more capable than you in a given domain.\n\n'
        'The idea is to pretend you are Batman, or another who excels in the '
        'given domain, and to take on their characteristics.\n\n'
        ...
        'might imagine myself the way hackers are depicted in movies - in a dark '
        ...
        'I am certain I do not look this way in reality, but it can have an '
        'empowering effect.\n\n'
  ...
  Post(
    ...
    body: 'If we would like to improve, we must reach.\n\n'
        'To reach is to try to achieve something beyond our current perceived capabilities.\n\n'
        ...
        'If we are willing to look a little foolish, to be rejected, and to fail, we '
        'can improve our rate of improvement.',
  ),
  Post(
  ...
  Post(
    ...
    body: 'Common themes continue to present themselves as I read about '
        'philosophy, psychology, and ancient religion.\n\n'
        ...
        'We should therefore focus on our behaviours rather than outcomes to '
  ...
  Post(
    ...
    body:
        ...
        'Continue to do this until you have asked why five times.\n\n'
        'This can help to identify our core values and motivation.\n\n'
        ...
        'This exercise can help us see the big picture and understand '
  ...
  Post(
    ...
    body: 'Misinformation is more rampant and convincing than ever.\n\n'
        ...
        'Perhaps more damaging, is social media, which is prone to containing '
        'more misinformation than truth.\n\n'
        'With the rise of generative artificial intelligence, it has never been easier '
        'to create fake news or content.\n\n'
        'All this information can lead us to believe what we see is all there '
        'is. This is an example of availability bias, where we believe what we can '
        'most easily recall.\n\n'
        'What we can easily recall is what we consistently see, and in this day and '
        'age, is often misinformation.\n\n'
        'We need to appreciate there is a lot of information we do not see.\n\n'
        'We should choose to subscribe to newsletters that report on positive news, '
        'giving us a more positive outlook on the world.\n\n'
        'If we see something on social media, or even the news, we should '
        'question its validity.\n\n'
        'Consider why what is being reported might be designed to elicit an '
        ...
        'not incentivised to push an agenda.\n\n'
  ...
  Post(
    ...
    id: '120',
    body:
        'To most, the thought of plunging into cold water is not appealing.\n\n'
        'So, why would one put themselves through such a routine?\n\n'
        ...
        'In addition to this; there are claimed benefits which are currently backed by only weak evidence, including:\n\n'
        ...
        'Through my own experience with cold showers and the occasional plunge '
        'into cold water when the opportunity presents itself, I have experienced '
        'the following subjective benefits:\n\n'
        ...
        'it slow.\n\n'
        'Begin by gradually turning the water cold at the end of your warm '
  ...
  Post(
    ...
    body: 'In 1970, a study was conducted at Stanford University which '
        ...
        'innately more willpower, but it turns out this is not the case.\n\n'
        ...
        'When we can change our focus, we remove the need for willpower.\n\n'
  ...
  Post(
    ...
    body: 'It is important to remind ourselves every day of what we have.\n\n'
        ...
        'Take the time each day to remind yourself of your reasons to be '
        'grateful.\n\n'
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '113',
    body: 'Sleep is another, and perhaps the most underrated pillar '
        'of health.\n\n'
        'Many have a tendency to de-prioritise sleep in favour of activities such '
        'as work, socialising, or "one more" episode of their favourite show, '
        'when in reality, sleep should be protected and prioritised.\n\n'
        'I went through a phase when working with people living with chronic '
        'pain, where I became deeply interested in sleep.\n\n'
        'It got to the point where I was over-analysing my sleep, which I now '
        'recognise to be detrimental.\n\n'
        'My recommendation is to adhere to some sleep hygiene practices '
        'which work for you, and to otherwise not stress about it.\n\n'
        'First, why do we need adequate sleep?\n\n'
        'I recommend reading "Why We Sleep" by Matthew Walker, but in short, '
        'a few of the key benefits of sleep are as follows:\n'
        ...
        'These are just guidelines, and some people may require more or less sleep.\n\n'
        'It should be individualised based on how you feel and perform.\n\n'
        'Finally, how can we improve our sleep?\n\n'
        'Sleep hygiene is a term used to describe a set of practices and habits '
        'that may be helpful to imrpove sleep.\n\n'
        'This does not mean hygiene in the sense of having a shower before bed, '
        ...
        '- Exercising regularly but not too strenuously close to bed time\n'
        '- Getting exposure to sunlight at the start of your day\n'
        '- Making your sleep environment comfortable, dark, quiet and cool\n'
        '- Limiting exposure to screens close to bed time\n'
        '- Not using your bed for activities other than sleep and sex\n'
        '- Going to bed when you are tired - catching the sleep wave, rather than '
        'trying to force sleep\n\n'
        'An important note on napping:\n\n'
        'Napping is completely ok.\n\n'
        'Many cultures have a siesta, which can be referred to as a biphasic sleep '
        'pattern.\n\n'
        'This can be beneficial for people who struggle to get enough '
        'sleep at night.\n\n'
        'It is important to develop a routine that works for you and limit your '
        'nap time to 30-90 minutes.\n\n'
        'Again, I reiterate that while sleep is important, you should not obsess '
        'over it and try to analyse everything. This will only lead to you being '
        'less able to sleep by fixating on minor fluctuations which are normal.',
  ),
  Post(
    title: 'Eat Well',
    datePosted: DateTime(2024, 2, 9),
    image: 'images/1.png',
    id: '112',
  ...
  Post(
    ...
    image: 'images/1.png',
    id: '88',
    body: 'Those who pursue happiness are often unsucessful.\n\n'
        'Happiness cannot be attained this way.\n\n'
        'Rather, it is a byproduct of living a life of purpose.\n\n'
        'Do not pursue happiness, pursue purpose, and happiness will follow.',
  ),
  Post(
    title: 'Blame',
  ...
  Post(
    ...
    body: 'Time management is important.\n\n'
        'It is essential if you wish to improve your productivity.\n\n'
        'However, I have come to realise energy management is more important.\n\n'
        'You may manage your time down to the second, but if you do not have the energy to do your work, your efforts are futile.\n\n'
        'So, manage your energy, eat well, exercise, prioritise rest and silence, and be more productive.',
  ),
  Post(
    title: 'Fall 7, Rise 8',
    ...
    id: '71',
    body: 'Fall 7, Rise 8.\n\n'
        'This is a Japanese proverb that means that if you fall down 7 times, you should get up 8 times.\n\n'
        'This proverb is often used to encourage people to keep trying, even if they fail.\n\n'
        'It is also used to encourage people to keep trying, even if they succeed.\n\n'
        'If you succeed, you should keep trying to improve.\n\n'
        'If you fail, you should keep trying to succeed.\n\n\n'
        'This article was generated by GitHub Copilot, a new AI-powered tool that helps you write code faster and more efficiently.',
  ),
  Post(
